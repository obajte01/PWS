...
<?php foreach ($this->items as $stock) : ?>
    <?php $onePrinter = (int)$stock->quantity_min / (int)printerCount?>
    <?php if (($stock->quantity_stock > ($onePrinter*(int)printerCount)) && ($stock->quantity_stock < ($onePrinter*(int)printerWarning))) : ?>
